...
parser.add_argument("-architecture", type=str, help="the instruction set architecture to generate and run instructions in", choices=["mips32", "x86_64"], default="mips32")
...
parser.add_argument("-iterations", type=int, help="the number of times an instruction is randomly run for each register in the specified ISA", default=10)
parser.add_argument("-analysis_model", type=int, help="the mathematical model used for analysis: 0 - reg-correlations, 1 - mem-reg-correlations", choices=[0, 1], default=1)
parser.add_argument("-output_model", type=int, help="choose the model for output: 0 - matrix, 1 - threshold", choices=[0,1], default=1)
...
parser.add_argument("-threshold", type=float, help="the correlation threshold for instructions to register as tainted", default=0.5)
